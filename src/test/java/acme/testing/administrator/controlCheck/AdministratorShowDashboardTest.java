...
public class AdministratorShowDashboardTest extends AcmePlannerTest {
	...
	public void administratoDashboardPositive() {
		...
		Assertions.assertEquals("0.43", ratioOfTrueCheck.getText());
		
		final By locatorRatioCheckFalseTasks;
		locatorRatioCheckFalseTasks = By.xpath("/html/body/div[2]/div/table/tbody/tr[3]/td");
		final WebElement numberOfFalseCheck = this.driver.findElement(locatorRatioCheckFalseTasks);
		Assertions.assertEquals("0.57", numberOfFalseCheck.getText());
		
		final By locatorAverageofCurrency1;
		locatorAverageofCurrency1 = By.xpath("/html/body/div[2]/div/table/tbody/tr[4]/td");
		...
		locatorAverageofCurrency2 = By.xpath("/html/body/div[2]/div/table/tbody/tr[5]/td");
		...
		locatorNumberPublicTasks = By.xpath("/html/body/div[2]/div/table/tbody/tr[8]/td");
		...
		locatorNumberPrivateTask = By.xpath("/html/body/div[2]/div/table/tbody/tr[9]/td");
		...
		locatorNumberFinalTask = By.xpath("/html/body/div[2]/div/table/tbody/tr[10]/td");
		...
		locatorNumberNoFinalTask = By.xpath("/html/body/div[2]/div/table/tbody/tr[11]/td");
		...
		locatorAverageDurationPeriodTasks = By.xpath("/html/body/div[2]/div/table/tbody/tr[12]/td");
		...
		locatorDeviationDurationPeriodTasks = By.xpath("/html/body/div[2]/div/table/tbody/tr[13]/td");
		...
		locatorMinimumDurationPeriodTasks = By.xpath("/html/body/div[2]/div/table/tbody/tr[14]/td");
		...
		locatorMaximumDurationPeriodTasks = By.xpath("/html/body/div[2]/div/table/tbody/tr[15]/td");
		...
		locatorAverageWorkloadTasks = By.xpath("/html/body/div[2]/div/table/tbody/tr[16]/td");
		...
		locatorDeviationWorkloadTasks = By.xpath("/html/body/div[2]/div/table/tbody/tr[17]/td");
		...
		locatorMinimumWorkloadTasks = By.xpath("/html/body/div[2]/div/table/tbody/tr[18]/td");
		...
		locatorMaximumWorkloadTasks = By.xpath("/html/body/div[2]/div/table/tbody/tr[19]/td");
