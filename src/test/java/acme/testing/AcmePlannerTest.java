...
public class AcmePlannerTest extends AcmeTest{
	...
	protected void signUp(final String username, final String password, final String name, final String surname, final String email, final String phone, final String accept) {
		assert !StringHelper.isBlank(username);
		assert !StringHelper.isBlank(password);
