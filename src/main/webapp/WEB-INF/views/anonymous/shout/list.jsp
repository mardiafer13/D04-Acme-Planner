...
<acme:list readonly="true">
	...
	<acme:list-column code="anonymous.shout.list.label.date" path="date" width="20%"/>
	<acme:list-column code="anonymous.shout.list.label.money" path="money" width="20%"/>
	<acme:list-column code="anonymous.shout.list.label.isCheck" path="isCheck" width="20%"/>
</acme:list>
