...
<acme:list readonly="true">
	...
	<acme:list-column code="anonymous.shout.list.label.date" path="control.date" width="20%"/>
	<acme:list-column code="anonymous.shout.list.label.money" path="control.money" width="20%"/>
	<acme:list-column code="anonymous.shout.list.label.isCheck" path="control.isCheck" width="20%"/>
</acme:list>
