...
public class AdministratorDashboardShowService implements AbstractShowService<Administrator, Dashboard> {
	...
	public void unbind(final Request<Dashboard> request, final Dashboard entity, final Model model) {
		...
		request.unbind(entity, model, //
			...
			"averageWorkloadTasks","deviationWorkloadTasks","minimumWorkloadTasks","maximumWorkloadTasks","ratioAtributo4True","ratioAtributo4False","ratioOfShoutsYear2020", "averageCurrency1", "averageCurrency2", "deviationCurrency1" ,"deviationCurrency2");
	}
	...
	public Dashboard findOne(final Request<Dashboard> request) {
		...
		//final Double ratioOfShoutsYear2020;
