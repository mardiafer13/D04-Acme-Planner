...
//			"numberOfCheckTrue", "ratioCheckTrue","ratioCheckFalse", "averageMoneyEUR", "averageMoneyDollar",
//			"deviationMoneyEUR", "deviationMoneyDollar");
//	}
//
//	@Override
...
//		final Double ratioCheckTrue;
//		final Double ratioCheckFalse;
//		final Double averageMoneyEUR;
//		final Double averageMoneyDollar;
//		final Double deviationMoneyEUR;
//		final Double deviationMoneyDollar;
//		//Fin parte examen
//
...
//
//		//Parte examen
//		numberOfCheckTrue = this.repository.numberShoutsFlagTrue();
//		ratioCheckTrue = this.repository.ratioOfShoutsWhoseFlagsAreTrue();
//		ratioCheckFalse = this.repository.ratioOfShoutsWhoseFlagsAreFalse();
//
//		final List<Double> averageShoutMoney = this.repository.averageMoneyGroupByCurrency();
//		final List<Double> deviationShoutMoney = this.repository.deviationMoneyGroupByCurrency();
//
//		averageMoneyEUR = averageShoutMoney.get(0);
//		deviationMoneyEUR = deviationShoutMoney.get(0);
////		averageMoneyDollar = averageShoutMoney.get(1);
////		deviationMoneyDollar = deviationShoutMoney.get(1);
//
//		//fin parte examen
//
...
//		result.setAverageMoneyEUR(averageMoneyEUR);
////        result.setAverageMoneyDollar(averageMoneyDollar);
//        result.setDeviationMoneyEUR(deviationMoneyEUR);
////        result.setDeviationMoneyDollar(deviationMoneyDollar);
//		
//		//Fin parte examen
//
//		return result;
