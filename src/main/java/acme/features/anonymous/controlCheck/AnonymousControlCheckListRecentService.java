...
//
//@Service
//public class AnonymousControlCheckListRecentService implements AbstractListService<Anonymous, ControlCheck> {
//
//	@Autowired
...
//	
//	@Override
//	public List<ControlCheck> findMany(final Request<ControlCheck> request) {
//		assert request != null;
//		final List<ControlCheck> res = new ArrayList<>();
//		final Collection<ControlCheck> shouts = this.repository.findMany();
